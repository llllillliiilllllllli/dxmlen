...
namespace DxMLEngine.Features
{
    ...
    internal class CrunchBaseAcquisitionData
    {
        private static HtmlDocument ReadWebpage(string path)
        {
            if (!Path.IsPathFullyQualified(path))
    ...
    internal class CrunchBaseContactData
    {
        ...
        private static string[] ConfigureHeader()
        {
            var header = new List<string>()
            {
                ...
                "Number of Private Contacts",
                "Number of Contact's Emails",
                "Number of Contact's Phones",
    ...
    internal class CrunchBaseEventData
    {
    ...
    internal class CrunchBaseFundingData
    {
        private static HtmlDocument ReadWebpage(string path)
        {
            if (!Path.IsPathFullyQualified(path))
    ...
    internal class CrunchBaseHubData
    {
        private static HtmlDocument ReadWebpage(string path)
        {
            if (!Path.IsPathFullyQualified(path))
    ...
    internal class CrunchBaseInvestorData
    {
    ...
    internal class CrunchBasePeopleData
    {
    ...
    internal class CrunchBaseSchoolData
    {
